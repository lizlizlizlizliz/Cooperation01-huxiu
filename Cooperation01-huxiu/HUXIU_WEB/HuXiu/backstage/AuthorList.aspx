			...
			<asp:Repeater ID="Rpt" runat="server" OnItemCommand="Rpt_ItemCommand">
                <ItemTemplate>
                    ...
                    <tr>
				        ...
				        <td><%#Eval("AuthorSex").ToString() == "True" ?"男":"女" %></td>
				        <td><%#Eval("AuthorSummary") %></td>
				        <td><asp:LinkButton ID="lbDelete" runat="server" Text="删除" CommandName="delete" CommandArgument='<%#Eval("AuthorId") %>'></asp:LinkButton></td>
			        </tr>	
