		...
		<br /><table cellspacing="0" cellpadding="0">
			...
			<asp:Repeater ID="Rpt" runat="server" OnItemCommand="Rpt_ItemCommand">
                <ItemTemplate>
                    ...
                    <tr>
				        <td> <asp:LinkButton ID="lbTitle" runat="server" Text='<%#Eval("ActivityTitle") %>' PostBackUrl='<%# "ActivityEditor.aspx?id="+ Eval("ActivityId") %>'></asp:LinkButton></td>
				        <td><%#Eval("ActivityWhat") %></td>
				        <td><%#Eval("ActivityWhen") %></td>
				        <td><%#Eval("ActivityWhere") %></td>
                        <td><%#Eval("ActivityTips") %></td>
				        <td><asp:LinkButton ID="lbDelete" runat="server" Text="删除" CommandName="delete" CommandArgument='<%#Eval("ActivityId") %>'></asp:LinkButton></td>
			        </tr>	
