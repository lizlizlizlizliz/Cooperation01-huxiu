		...
		<br /><table cellspacing="0" cellpadding="0">
			...
			<asp:Repeater ID="Rpt" runat="server" OnItemCommand="Rpt_ItemCommand">
                <ItemTemplate>
                    ...
                    <tr>
				        <td> <asp:LinkButton ID="lbTitle" runat="server" Text='<%#Eval("NewsTitle") %>' PostBackUrl='<%# "NewsEditor.aspx?id="+ Eval("NewsId") %>'></asp:LinkButton></td>
				        <td><%#Eval("NewsBody") %></td>
				        <td><%#Eval("NewsDate") %></td>
				        <td><a href='<%#Eval("NewsLink") %>'><%#Eval("NewsLink") %></a></td>
				        <td><asp:LinkButton ID="lbDelete" runat="server" Text="删除" CommandName="delete" CommandArgument='<%#Eval("NewsId") %>'></asp:LinkButton></td>
			        </tr>	
                </ItemTemplate>
            </asp:Repeater>
